...
dbox.controller('mmgCommunityModalController', function ($scope, genericService) {
    ...
    var getFilter = function (isCounter) {
        ...
        filter.getList = true;
        filter.community_id = $scope.community._id;
    ...
    $scope.getList = function(community){
    ...
    $scope.edit_list = function (list) {
        $(mmgCommunityModal).modal('hide');
        getScope(addListModal).edit($scope.community._id, list);
    }
