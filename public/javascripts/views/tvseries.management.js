...
dbox.controller('mmgTvSeriesModalController', function ($scope, genericService) {
    ...
    var getFilter = function (isCounter) {
        ...
        filter.getList = true;
        filter.tvserie_id = $scope.tvseries._id;
    ...
    // GET ARRAY OF TVSERIES BY ID
    $scope.getList = function(tvseries){
        
        if(tvseries)
            $scope.tvseries = tvseries;
    ...
    $scope.edit_list = function (list) {
        $(mmgTvSeriesModal).modal('hide');
        getScope(addListModal).edit($scope.tvseries._id, list);
    }
    ...
    $scope.getBasicFilter = function(list){
         ...
         if(!list.filter){
            list.filter =  {
                ...
                tvserie_id :list.tvserie_id,
                tvserie_list_id : list._id,
                getVideo: true
            };   
         }
